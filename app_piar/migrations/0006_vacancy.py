# Generated by Django 4.2.7 on 2023-12-11 06:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app_piar', '0005_rename_news_desc_en_anons_anons_desc_en'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vacancy_text_ru', models.TextField(blank=True, null=True, verbose_name='вакансии новости')),
                ('vacancy_text_en', models.TextField(blank=True, null=True, verbose_name='Vacancy text')),
                ...
                ('vacancy_status', models.BooleanField(default=True, verbose_name='Vacancy holati')),
            ],
        ),
    ]
